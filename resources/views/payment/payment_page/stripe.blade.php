                    ...
                    <form class="mb-3 require-validation" id="stripePaymentForm" data-cc-on-file="false">
                        ...
                        <div class='row'>
                            <div class='col-xs-12 form-group'>
                                <input type="number" autocomplete='off' name="card_number" class='form-control card-number'
                                    placeholder="Card Number" size='20' type='text'>
                            </div>
                        </div>

                        <div class='row mt-3'>
                            <div class='col-xs-12 col-md-4 form-group cvc'>
                                <input type="number" autocomplete='off' name="card-cvc" class='form-control card-cvc'
                                    size='4' type='text' placeholder="CVC">
                            </div>
                            <div class='col-xs-12 col-md-4 form-group expiration'>
                                <input type="number" min="1" max="12" class='form-control card-expiry-month'
                                    name="card-expiry-month" size='2' type='text' placeholder="Expiry Month">
                            </div>
                            <div class='col-xs-12 col-md-4 form-group expiration'>
                                <input type="number" class='form-control card-expiry-year' name="card-expiry-year"
                                    placeholder='Expiry Year' size='4' type='text'>
                            </div>
                        </div>
